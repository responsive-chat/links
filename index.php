...
function start_browse($CatID="")
{
	...
	if(!empty($data))
	{
		...
		print '<table width="100%" bordersize="0" cellpadding="0" cellspacing="0"><tr><td width="50%" align="center" valign="top">';
		print "<UL>\n";
...
function show_edit_link($LinkID="",$title="",$msg="")
{
	...
	print "<p><H3>ბმულის რედაქტირება კატეგორიაში: <B>$LinkCatName</B></H3><HR>
	<form action=\"".$_SERVER['PHP_SELF']."?update=1\" method=\"POST\">
	<input type=\"hidden\" name=\"LinkID\" value=\"$LinkID\">
	<table align=\"center\" border=\"1\">
	<tr><td><input name=\"Url\" placeholder=\"ბმული\" size=\"40\" VALUE=\"$Url\"></td></tr>
	<tr><td><input name=\"LinkName\" placeholder=\"სათაური\" size=\"40\" VALUE=\"$LinkName\"></td></tr>
	<tr><td><textarea name=\"Description\" placeholder=\"აღწერა\" rows=\"3\" cols=\"40\">$Desc</textarea></td></tr>
	<tr><td><input name=\"SubmitName\" placeholder=\"თქვენი სახელი\" size=\"40\" VALUE=\"$Name\"></td></tr>
	<tr><td><input name=\"SubmitEmail\" placeholder=\"თქვენი ელ. ფოსტა\" size=\"40\" VALUE=\"$Email\"></td></tr>
	<tr></td><td>";
...
function show_add_link($add = "NULL", $CatName = "Unknown")
{
	...
	print_header($add);
	print "
	<p><H3>კატეგორია: <B>$CatName</B></H3><HR noshade>
	<form action=\"".$_SERVER['PHP_SELF']."?suggest=1\" method=\"POST\">
	<input type=\"hidden\" name=\"CatID\" value=\"$add\">
	<table align=\"center\" border=\"1\">
	<tr><td><input name=\"Url\" placeholder=\"ბმული\" size=\"40\" VALUE=\"http://\"></td></tr>
	<tr><td><input name=\"LinkName\" placeholder=\"სათაური\" size=\"40\"></td></tr>
	<tr><td><textarea name=\"Description\" placeholder=\"აღწერა\" rows=\"3\" cols=\"40\"></textarea></td></tr>
	<tr><td><input name=\"SubmitName\" value=\"$UserName\" placeholder=\"თქვენი სახელი\" size=\"40\"></td></tr>
	<tr><td><input name=\"SubmitEmail\" value=\"$UserEmail\" placeholder=\"თქვენი ელ. ფოსტა\" size=\"40\"></td></tr>
...
{
	if("$ADMIN_MODE" == "true") {
		print "<p>თქვენ ხართ ადმინისტრატორი<UL>";
