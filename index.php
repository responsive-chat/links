...
{
	if("$ADMIN_MODE" == "true") {
		print "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no\"><p>თქვენ ხართ ადმინისტრატორი<UL>";
		...
		print "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no\"><form action=\"".$_SERVER['PHP_SELF']."?enter_admin=1\" method=\"POST\">";
